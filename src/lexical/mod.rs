...
// which the author condensed into this minimal subset for use in serde_json_untagged.
// For the serde_json_untagged use case we care more about reliably round tripping all
...
//
// Dual licensed as MIT and Apache 2.0 just like the rest of serde_json_untagged, but
